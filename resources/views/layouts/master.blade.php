      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            <a class="nav-link active" aria-current="page" href="#"><h2 class="fw-normal" style="color:	#36454F ">R.D.I</h2></a>
            <a class="nav-link" href="#"><h4 class="fw-normal pt-2" style="color:	#36454F ">   </h4></a>

            <a class=" -5 nav-link" href="#"><h4 class="fw-normal pt-2" style="color:	#36454F "> PROYECTOS</h4></a>
          </div>
        </div>
      </div>
    </nav>
